...
public class MainCar {
    public static void main(String[] args) {
        ...
        System.out.println("Simple car can accept baggage with weight "
                + String.valueOf(simpleCar.getBaggageWeight()));

        Car sportCar = new SportCar(simpleCar);
        System.out.println("Speed of sport car - " + String.valueOf(sportCar.getSpeed()));
        System.out.println("Sport car can accept baggage with weight "
                + String.valueOf(sportCar.getBaggageWeight()));
        ...
        System.out.println("Truck can accept baggage with weight "
                + String.valueOf(truck.getBaggageWeight()));
    }
}
